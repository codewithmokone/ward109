  ...
  return (
    <section className="py-32 bg-slate-900 text-white text-center relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 max-w-4xl relative z-10">
        ...
        <p className="text-xl md:text-2xl text-[#F9721F] font-bold mb-4 uppercase tracking-widest">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[100, 250, 500, 1000].map(amount => (
            <button key={amount} variant="outline" className="bg-slate-800/50 border-slate-700 text-white hover:bg-[#F9721F] hover:border-[#F9721F] hover:text-white text-2xl font-bold h-20 rounded-2xl transition-all duration-300">
              R{amount}
            </button>
          ))}
        </div>
        <button size="lg" className="bg-[#F9721F] hover:bg-[#F9721F]/90 text-white text-xl h-16 px-12 rounded-full w-full md:w-auto shadow-lg shadow-[#F9721F]/30">
