                ...
                <div className="grid md:grid-cols-2 gap-20 items-start">
                    <div>
                        <div className="inline-flex items-center gap-2 text-secondary font-bold tracking-wide uppercase text-sm mb-4">
                            <span className="w-8 h-[2px] bg-secondary"></span> Contact Us
                        </div>
                        ...
                        <div className="space-y-8">
                            <div className="flex items-start gap-6 group">
                                <div className="w-12 h-12 rounded-full bg-slate-100 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-colors shrink-0">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            <div className="grid grid-cols-2 gap-6">
                                <div className="space-y-2">
                                    ...
                                    <input required className="bg-white border-slate-300 h-12 text-lg focus-visible:ring-primary" placeholder="Sipho" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-sm font-bold text-slate-700">Last Name</label>
                                    <input required className="bg-white border-slate-300 h-12 text-lg focus-visible:ring-primary" placeholder="Ndlovu" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700">Email Address</label>
                                <input required type="email" className="bg-white border-slate-300 h-12 text-lg focus-visible:ring-primary" placeholder="sipho@example.co.za" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700">Phone Number</label>
                                <input required type="tel" className="bg-white border-slate-300 h-12 text-lg focus-visible:ring-primary" placeholder="082 000 0000" />
                            </div>
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700">How would you like to help?</label>
                                <textarea className="bg-white border-slate-300 min-h-[120px] text-lg focus-visible:ring-primary resize-none" placeholder="Distributing flyers, hosting meetings, etc." />
                            </div>
                            <button type="submit" className="w-full bg-primary hover:bg-primary/90 text-white h-14 text-xl font-bold rounded-xl mt-4">
                                I'm In
                            </button>
                        </form>
                    </div>
