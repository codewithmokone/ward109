  ...
  return (
    <section id='home' className="relative min-h-[95vh] flex items-center justify-center overflow-hidden">
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-r from-[#1142BB]/95 via-[#1142BB]/80 to-transparent"></div>
      ...
      <div className="container relative z-10 mx-auto px-6 max-w-6xl mt-20">
        <div className="max-w-3xl text-white">
          ...
          >
            ...
            <a href="../src/assets/Abridged_BP_programme.pdf" download="Abridged_BP_Programme.pdf">
              <button className="bg-white/10 flex items-center gap-2 border text-white font-semibold border-white/30 hover:bg-white hover:text-[#1142BB] text-lg h-14 px-12 rounded-full backdrop-blur-sm">
                <FileDown /> Batho Pele Doc
              </button>
            </a>
          </motion.div>
        </div>
